  ...
  return (
    <div style={{ background: "lightgray", }}>
      ...
      <div className="container-fluid pt-4">
                ...
                <div className="container-fluid">
                  <div className="row">
                    <div className="col text-center" style={{ paddingTop: "1.5rem" }}>
                      ...
                      <p>Avaliable currency: {avalibleCurrency || "~"}<span role="img" aria-label="canvasCurrency">🍪</span></p>
                    </div>
        ...
        <CanvasCarousel carouselName={"My Canvases"} carouselNameLink={"/allcanvases"} createCanvasElement={allCanvases} />
